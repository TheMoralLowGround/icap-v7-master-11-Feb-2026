...
def standardize_dimensions(input_string):
    """
    ...
    try:
        if "CTNS:" in input_string:
            ...
            dimensions = parts[1]
            input_string = f"{dimensions}*{quantity}"
        ...
        if count_digits_followed_by_star(input_string) == 4:
            ...
            asteric_string = "*".join(input_string_split[: len(input_string_split) - 1])
            last_string = input_string_split[-1]
            input_string = f"{asteric_string}x{last_string}"
        return input_string
    except:
        print(traceback.print_exc())
        return copy_string
...
def process(input_string):
    ...
    try:
        input_string = standardize_dimensions(input_string)
...
def get_parsed_dimension(data_json):
    ...
    for table_idx, table in enumerate(data_json["table_data"]):
        ...
        for row_idx, row in enumerate(row_data):
            single_row_data = copy.deepcopy(row["row_data"])
            for col_id, col_data in enumerate(single_row_data):
                if fuzz.ratio(col_data["label"].lower().strip(),"dimenssion") >= 85 or "dimensssion" in col_data["label"].lower().strip():

                    parsed_dimenssion_data_list =  process(col_data["value"])
                    for  singe_parsed_data_list in parsed_dimenssion_data_list:

                        if len(singe_parsed_data_list) == 5:
                             row["row_data"].append({"label":"length", "value":singe_parsed_data_list[0],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                             row["row_data"].append({"label":"width", "value":singe_parsed_data_list[1],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                             row["row_data"].append({"label":"height", "value":singe_parsed_data_list[2],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                             row["row_data"].append({"label":"uom", "value":singe_parsed_data_list[3],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                             if singe_parsed_data_list[4]:
                                row["row_data"].append({"label":"extra_data", "value":singe_parsed_data_list[4],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})


                        elif len(singe_parsed_data_list) == 6:
                            row["row_data"].append({"label":"length", "value":singe_parsed_data_list[0],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"width", "value":singe_parsed_data_list[1],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"height", "value":singe_parsed_data_list[2],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"uom", "value":singe_parsed_data_list[3],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            if singe_parsed_data_list[4]:
                                row["row_data"].append({"label":"extra_data", "value":singe_parsed_data_list[4],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"package_count", "value":singe_parsed_data_list[5],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})

                        elif len(singe_parsed_data_list) == 7:
                            row["row_data"].append({"label":"length", "value":singe_parsed_data_list[0],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"width", "value":singe_parsed_data_list[1],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"height", "value":singe_parsed_data_list[2],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"uom", "value":singe_parsed_data_list[3],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            if singe_parsed_data_list[4]:
                                row["row_data"].append({"label":"extra_data", "value":singe_parsed_data_list[4],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"package_count", "value":singe_parsed_data_list[5],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"package_type", "value":singe_parsed_data_list[6],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})

                        elif len(singe_parsed_data_list) == 8:
                            row["row_data"].append({"label":"length", "value":singe_parsed_data_list[0],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"width", "value":singe_parsed_data_list[1],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"height", "value":singe_parsed_data_list[2],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"uom", "value":singe_parsed_data_list[3],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"package_count", "value":singe_parsed_data_list[4],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"package_type", "value":singe_parsed_data_list[5],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"innerPackageCount", "value":singe_parsed_data_list[6],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"innerPackageType", "value":singe_parsed_data_list[7],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})

                        elif len(singe_parsed_data_list) == 9:
                            row["row_data"].append({"label":"length", "value":singe_parsed_data_list[0],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"width", "value":singe_parsed_data_list[1],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"height", "value":singe_parsed_data_list[2],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"uom", "value":singe_parsed_data_list[3],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            ...
                            row["row_data"].append({"label":"package_count", "value":singe_parsed_data_list[5],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"package_type", "value":singe_parsed_data_list[6],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"grossWeight", "value":singe_parsed_data_list[7],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
                            row["row_data"].append({"label":"grossWeightUom", "value":singe_parsed_data_list[8],"is_profile_key_found": True,"page_id":col_data.get("page_id","")})
    return data_json                    

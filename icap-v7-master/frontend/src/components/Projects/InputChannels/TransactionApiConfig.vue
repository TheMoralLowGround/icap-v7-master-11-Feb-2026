    ...
    <div class="mb-4">
      ...
      <div>
        <div class="d-flex align-items-center mb-3">
          ...
          <code>/api/pipeline/process_transaction/</code>
        </div>
        <h5 class="mb-2">
          Body Parameters
        </h5>
        ...
        <BCard class="bg-black text-light mb-2 position-relative">
          <div class="d-flex justify-content-end mb-2">
            <BButton
              ...
              size="sm"
              @click="exportJson(requestPayload, 'transaction-request')"
            >
              <feather-icon
                icon="DownloadIcon"
                size="14"
          ...
          <BCard class="bg-black text-light mb-4 position-relative">
            <div class="d-flex justify-content-end mb-2">
              <BButton
                variant="outline-light"
                size="sm"
                @click="exportJson(responseData.data, 'transaction-response')"
              >
                <feather-icon
                  icon="DownloadIcon"
                  size="14"
      ...
      <BRow>
        <BCol md="6">
          <div class="d-flex align-items-start mb-2">
            ...
            <div>
              <strong>OK</strong><br>
              <small class="text-muted">Transaction processed successfully</small>
            </div>
          </div>
          <div class="d-flex align-items-start mb-2">
            <BBadge
            ...
            <div>
              ...
              <small class="text-muted">Incorrect request format</small>
            </div>
          </div>
          <div class="d-flex align-items-start mb-2">
            <BBadge
            ...
            <div>
              ...
              <small class="text-muted">Transaction validation failed</small>
            </div>
          </div>
        </BCol>
        <BCol md="6">
  ...
  methods: {
    ...
    async tryItOut() {
      ...
      try {
        ...
        const response = await axios.post('/pipeline/process_transaction/', formData)
        ...
        this.errorResponse = {
          ...
          data: error.response?.data || {
            error: error.response?.data?.error || 'Failed to connect to the server',
    ...
    getStatusText(status) {
      const statusTexts = {
        ...
        422: 'Validation Error - Transaction validation failed',

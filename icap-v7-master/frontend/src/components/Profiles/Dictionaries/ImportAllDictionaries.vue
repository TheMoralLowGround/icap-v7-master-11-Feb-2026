<template>
  <div>
    ...
    >
      ...
      >
        <div class="alert-body">
          This will import all dictionaries from the Excel file into the current process.
        </div>
      </b-alert>
    </b-modal>
  </div>
    ...
    async handleImport(bvModalEvt) {
      ...
      try {
        ...
        const response = await axios.post(
          ...
          {
            params: {
              endpoint: `dictionaries/processes/${this.processUid}/import`,
              request_type: 'POST',
            },
            headers: {
        ...
        this.$toast({
          ...
          props: {
            title: 'All dictionaries imported successfully',
            icon: 'CheckIcon',
            variant: 'success',
          },
        })

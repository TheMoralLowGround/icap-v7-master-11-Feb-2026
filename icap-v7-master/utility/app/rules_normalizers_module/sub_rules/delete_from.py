...
def apply_delete_from(rule_inputs, input_text):
    try:
        if isinstance(input_text, list):
            return perform_list_inputs_rules(apply_delete_from, input_text, rule_inputs)
        ...
        if string_manipulation_type == "string":
            ...
            output_text = re.split(manipulative_value, output_text)[0]
            return output_text.strip()
    except:
        pass
    return input_text

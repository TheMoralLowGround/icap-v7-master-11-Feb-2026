from . import clean_line_blocks, get_left_pos_str, get_right_pos_str
...
def process(data_word_only, data, find_key_a, find_key_b, line_data):
    ...
    for line in line_data:
        ...
        horizontal_line_data_chunks = clean_line_blocks.process(line_data_chunks)
